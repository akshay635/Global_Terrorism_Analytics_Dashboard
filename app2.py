...
def load_data():
    dataset_name = "C:/Users/aksha/Global_Terrorism_Dash_App_Updated/plotly_dash_app/data/global_terror.csv.gz"  # Name of the CSV file containing data
...
def update_app_ui(Tabs, month_value, date_value, region_value, country_value, state_value, city_value,
    ...
    if Tabs == "Map":
        ...
        color_map = {
            "Armed Assault": "#e41a1c",
            "Bombing/Explosion": "#377eb8",
            "Assassination": "#4daf4a",
            "Hijacking": "#984ea3",
            "Hostage Taking (Kidnapping)": "#ff7f00",
            "Facility/Infrastructure Attack": "#a65628",
            "Unarmed Assault": "#f781bf",
            "Unknown": "#999999"}

        
        # Create the map figure using Plotly
        mapFigure = px.scatter_map(
            new_df,
            lat="latitude",
            lon="longitude",
...
def open_webbrowser():
    webbrowser.open_new('http://127.0.0.1:8050/terrorism_analysis_with_insights/')
